...
public class Polygon extends Shape{
	...
	public static Polygon getRegularPolygon(int sides, int radius, Point2D.Double center) {
	...
	public static Polygon getStellatedPolygon(int stellations, int radius, int apothem, Point2D.Double center) {
	...
	public Polygon(Point2D.Double...pointsAsArray) {
		double xValCenter = 0;
		double yValCenter = 0;
	...
	public Shape createCopy() {
		Point2D.Double[] pointArray = new Point2D.Double[points.size()];
		return new Polygon(this.points.toArray(pointArray));
	}
