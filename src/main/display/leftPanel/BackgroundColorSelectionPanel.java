...
public class BackgroundColorSelectionPanel extends JPanel{
	...
	public BackgroundColorSelectionPanel(ShapeDrawSpecifications specs, PreviewCanvas preview) {
		...
		ColorSelectionBox colorSelectPanel = new ColorSelectionBox();
		colorSelectContainer.add(colorSelectPanel);
		this.add(colorSelectContainer);
	}
	
	private class ColorSelectionBox extends JPanel{ 
		...
		BufferedImage selfReferentialImage = null;
		...
		public ColorSelectionBox() {
			...
			this.addMouseListener(new MouseListener() {
				...
				public void mouseClicked(MouseEvent e) {
			        ...
			        printAll(g2);
			        g2.dispose();
					specs.setBackgroundColor(new Color(selfReferentialImage.getRGB(mousPos.x, mousPos.y), true));
					specs.clearImage();
